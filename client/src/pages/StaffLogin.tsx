...
export default function StaffLogin() {
  ...
  return <div className="grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
    <section className="relative hidden overflow-hidden bg-[#10231f] p-12 text-white lg:flex lg:flex-col lg:justify-between">
      ...
      <div className="relative flex items-center gap-3"><span className="grid h-11 w-11 place-items-center rounded-xl bg-[#d9f99d] text-[#17352e]"><Store className="h-5 w-5" /></span><span className="text-xl font-semibold">Tindahan OS</span></div>
    ...
    <section className="flex items-center justify-center bg-[#f5f6f3] p-6 sm:p-10"><form onSubmit={submit} className="w-full max-w-md rounded-3xl border border-[#dde3dc] bg-white p-7 shadow-[0_24px_70px_-30px_rgba(16,35,31,0.35)] sm:p-10">
      <div className="mb-9"><div className="mb-5 flex items-center gap-3 lg:hidden"><span className="grid h-10 w-10 place-items-center rounded-xl bg-[#17352e] text-[#d9f99d]"><Store className="h-5 w-5" /></span><span className="font-semibold">Tindahan OS</span></div><p className="text-xs font-bold uppercase tracking-[0.18em] text-[#6b7d73]">Staff access</p><h2 className="mt-2 text-3xl font-semibold tracking-tight text-[#17352e]">Welcome back</h2><p className="mt-2 text-sm leading-6 text-[#6b7d73]">Sign in with your staff email and password.</p></div>
